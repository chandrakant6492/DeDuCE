...
[![DeDuCE model version](https://img.shields.io/badge/DeDuCE_model_version-1.0.1-green)](https://www.deforestationfootprint.earth/)
...
The manuscript detailing the model is archived at EarthArXiV: **_Singh, C., & Persson, U. M. (2026). Global patterns of commodity-driven deforestation and associated carbon emissions_** (_Accepted_) Nature Food. https://doi.org/10.1038/s43016-026-01305-4.  
...
### Processing time
**Google Earth Engine (GEE)**: GEE imposes usage limits to ensure equitable resource distribution among its users. Running the DeDuCE model's spatial attribution script (`1. Deforestation attribution (GEE)-Spatial`), requires approximately **356 hours** for a standard user privilege account for a single cycle of global spatial attribution.  
